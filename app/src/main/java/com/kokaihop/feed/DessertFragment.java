...
public class DessertFragment extends Fragment {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            AppUtility appUtility = new AppUtility();
            desertViewModel.getRecipeListWithAdds().clear();
            desertViewModel.getRecipeListWithAdds().addAll(desertViewModel.getRecipeList());
            appUtility.addAdvtInRecipeList(desertViewModel.getRecipeListWithAdds(), AppCredentials.DAILY_ADS_UNIT_IDS, getContext());
            feedRecyclerListingOperation.prepareFeedRecyclerView();
