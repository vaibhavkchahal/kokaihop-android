...
import com.kokaihop.login.LoginActivity;
...
public class SignUpViewModel extends BaseViewModel {
    ...
    public void login(final View view) {
        ...
        new SignUpApiHelper(view.getContext()).doLogin(userName, password, new IApiRequestComplete() {
            @Override
    ...
    public void forgot(final View view) {
        ...
        setProgressVisible(true);
        new SignUpApiHelper(view.getContext()).doForgot(userName, new IApiRequestComplete() {
            @Override
            public void onSuccess(Object response) {
